...
/**
* @author Numbgui
* @time   2016-05-26 09:16:10
*/
@Table("L_CKQFKFY_YW")
public class L_ckqfkfy_yw 
{
	@Column
	...
	public String getFk_fkid()
	{
		return fk_fkid;
	}
	public void setFk_fkid(String fk_fkid)
	{
		this.fk_fkid=fk_fkid;
	}
