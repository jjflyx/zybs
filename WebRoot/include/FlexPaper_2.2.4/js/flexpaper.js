...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    var _SWFFile,_PDFFile,_IMGFiles,_JSONFile  = "",_jsDirectory="",_cssDirectory="",_localeDirectory="";_WMode = (config.WMode!=null||config.wmmode!=null?config.wmmode||config.WMode:"window"),_porpath="";
    ...
    _porpath			= (config.porpath!=null?config.porpath:"");
    //alert(_porpath+",");
    ...
    window[instance] = flashembed(id, {
        ...
        version					    : [10, 0],
        expressInstall			    : _porpath+"js/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
