...
function Dialog() {
    var strID,w,h,title,url,closable,CancelButton;
    ...
    this.ID = strID;
    this.Modal = false;//原来=true，由于点击锁屏的时候，么有遮照层，改为了false
...
Dialog.prototype.show = function() {
    ...
    if(this.CancelButton){
    	...
    	arr.push("           	<input id='_ButtonCancel_" + this.ID + "' type='button' style=\"display: none;\" class='button' onclick=\"Dialog.getInstance('" + this.ID + "').close();\" value='取 消'>");
    }
    arr.push("            </div></td></tr>");
