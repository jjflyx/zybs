...
/*START_LOADSCRIPT*/
Server.loadScript(CONTEXTPATH + "/public/js/jquery-1.10.2.min.js");
Server.loadScript(CONTEXTPATH + "/public/js/jquery.hotkeys.js"); 
Server.loadScript(CONTEXTPATH + "/public/js/page.js");
Server.loadScript(CONTEXTPATH+"/public/js/Application.js");
Server.loadScript(CONTEXTPATH+"/public/js/datagrid.js"); 
Server.loadScript(CONTEXTPATH+"/public/js/drag.js"); 
Server.loadScript(CONTEXTPATH+"/public/js/dialog.js");  
Server.loadScript(CONTEXTPATH+"/public/js/datetime.js"); 
Server.loadScript(CONTEXTPATH+"/public/js/tip.js"); 
Server.loadScript(CONTEXTPATH+"/public/js/verify.js");
Server.loadScript(CONTEXTPATH+"/public/js/style.js"); 
