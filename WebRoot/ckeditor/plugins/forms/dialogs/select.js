        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                    ...
                    style: "width:100%",
                    setup: function(a, b) {
                        "clear" == a ? this.setValue(this["default"] || "") : "select" == a && this.setValue(b.getAttribute("name") || "")
                    },
                    commit: function(a) {
                ...
                },
                {
                    ...
                    type: "text",
                    // widths: ["25%", "75%"],
                    label: c.lang.common.textlabel,
                    //labelLayout: "horizontal",
                    validate: CKEDITOR.dialog.validate.notEmpty(c.lang.common.textlabel + c.lang.common.invalidValueNull),
                    "default": "",
                    accessKey: "N",
                    style: "width:100%",
                    setup: function(a) {
                        this.setValue(a.getAttribute("label_name") || "")
                    },
                    commit: function(a) {
                        this.getValue() ? a.setAttribute("label_name", this.getValue()) : a.removeAttribute("label_name")
                    }
                }]
            },
            {
            ...
            },
            {
                ...
                children: [{
                    ...
                    setup: function(a, b) {
                        "select" == a && this.setValue(b.getAttribute("width") || "");
                        CKEDITOR.env.webkit && this.getInputElement().setStyle("width", this.getValue() + "px")
                    },
                    commit: function(a) {
                        this.getValue() ? a.setAttribute("width", this.getValue()) : a.removeAttribute("width")
                    }
                },
                {
                    id: "txtSize",
                    ...
                    setup: function(a, b) {
                        ...
                        CKEDITOR.env.webkit && this.getInputElement().setStyle("width", "100%")
                    },
                    commit: function(a) {
            ...
            },
            {
                ...
                },
                {
                    id: "txtisnotnull",
                    type: "checkbox",
                    label: c.lang.common.isnotnull,
                    "default": "",
                    accessKey: "M",
                    value: "checked",
                    setup: function(a, b) {
                        "select" == a && this.setValue(b.getAttribute("txtisnotnull"));
                        CKEDITOR.env.webkit && this.getElement().getParent().setStyle("vertical-align", "middle")
                    },
                    commit: function(a) {
                        this.getValue() ? a.setAttribute("txtisnotnull", this.getValue()) : a.removeAttribute("txtisnotnull")
                    }
                }]
            }]
        }]
