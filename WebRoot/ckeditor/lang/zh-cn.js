...
CKEDITOR.lang['zh-cn'] = {
	...
	"commonfield":{//设置js中，属性统一,目前只针对 ckeditor标签中的id的值
		"fieldname":"name",//字段名称
		"labelname":"label_name",//标签名称
		"fieldvalue":"value",//标签值
		"checked":"checked",//checked选中
		"type":"type",//input 类型
		"datatype":"datatype",//字段类型
		"datelength":"datelength",//字段长度
		"clos":"clos",//列
		"rows":"rows",//行
		"is_null":"is_null",//是否为空
		"is_primary":"is_primary",//是否主键
		"maxlength":"maxLength",//input 最多字符数限制
		"validformat":"valid_format",//验证表达式
		"timeformat":"timeformat",//日期格式
		"istoday":"is_today"//日期是否显示今天
	}
};